package com.github.vazmin.framework.core.enu;
...
public enum StatusEnum {
    ...
    private StatusEnum(Integer code, String description) {
        this.code = code;
     ...
     * @return StatusEnum 枚举值，如果不存在返回 UNKNOWN
     */
    public static StatusEnum valueOf(Integer code) {
        if (code != null) {
            for (StatusEnum itemEnum: values()) {
