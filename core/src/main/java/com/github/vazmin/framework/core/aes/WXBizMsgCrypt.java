 ...
 * </ol>
 */
public class WXBizMsgCrypt extends BaseSecret {
	private static final Logger log = LoggerFactory.getLogger(WXBizMsgCrypt.class);

	protected static final int KEY_LENGTH = 43;
	...
	public String encrypt(String replyMsg, String timeStamp, String nonce)
		...
		String encrypt = encrypt(
                RandomStringUtils.randomAlphanumeric(IV_LENGTH), replyMsg);
		// 生成安全签名
		if (StringUtils.isBlank(timeStamp)) {
			timeStamp = Long.toString(System.currentTimeMillis());
		}
		String signature = ShaUtils.sha1Hex(token, timeStamp, nonce, encrypt);
	...
	public String decrypt(String msgSignature, String timeStamp,
		...
		// 验证安全签名
		String signature =
                ShaUtils.sha1Hex(token, timeStamp, nonce, encrypt[1].toString());
	...
	public String verifyUrl(String msgSignature, String timeStamp,
			...
			throws AesException {
		String signature = ShaUtils.sha1Hex(token, timeStamp, nonce, echoStr);
