...
public class HttpClientUtils {
    ...
    public static void main(String[] args) {
        try {
//            log.debug("HttpClientUtils Test");
//            String appKey = "1475919314000060";
//            String secretKey = "c410eb057e1a1ae0d0c4c9ae1cdbff25";
//            String deviceId = "cc7ffa7a11a67386";
//            String userId = "58cb92ae00c963b600000001";
//            long timestamp = System.currentTimeMillis();
//            String msg = String.format("%s%d%s%s",
//                    appKey, timestamp, secretKey, deviceId);
//            String sig = DigestUtils.sha1Hex(msg);
//            String params = String.format("appKey=%s&timestamp=%d&deviceId=%s&sig=%s&userId=%s",
//                    appKey, timestamp, deviceId, sig, userId);
//            String res = postForm("http://auth.cloud.chivox.com:8001/device", params);
//            log.debug("[" + params + "]");
//            log.debug("[" + res + "]");
